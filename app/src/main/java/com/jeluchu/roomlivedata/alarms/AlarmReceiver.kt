...
class AlarmReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (StringSplit.getIntAt0(Utils.millitohourmin(calendar.timeInMillis).trim()) < StringSplit.getIntAt0(
    ...
    fun showNotificationonDay(intent: Intent, context: Context) {
        ...
        val intentToRepeat = Intent(context, HomeScreenActivity::class.java)
